...
public class MyRectangle {
	...
	public void draw3D(ShapeRenderer s, MyCamera myCam, float W, float H) {
		...
		// s.line(p1.x*W-W/2, -H/2 + ttt.get(0).y *H/2, ttt.get(1).x*W-W/2, -H/2
		// + ttt.get(1).y *H/2);
		// s.line(ttt.get(1).x*W-W/2, -H/2 + ttt.get(1).y *H/2,
		// ttt.get(3).x*W-W/2, -H/2 + ttt.get(3).y *H/2);
		// s.line(ttt.get(2).x*W-W/2, -H/2 + ttt.get(2).y *H/2,
		// ttt.get(3).x*W-W/2, -H/2 + ttt.get(3).y *H/2);
		// s.line(ttt.get(2).x*W-W/2, -H/2 + ttt.get(2).y *H/2,
		// ttt.get(0).x*W-W/2, -H/2 + ttt.get(0).y *H/2);
